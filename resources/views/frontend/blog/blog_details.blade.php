...
@section('title')
    Chi tiết bài viết |{{ $blog->post_title }}
@endsection
...
@endforeach
                            ...
                            <div class="comment-box">
                                ...
                                <div class="comment">
                                    <figure class="thumb-box">
                                        <img style="height: 85px;" src="{{(!empty($com->user->photo)) ?url('upload/user_images/'.$com->user->photo) : url('upload/no_image.jpg')}}" alt="">
                                    </figure>
    ...
    @foreach ($reply as $rep)
                                ...
                                <div class="comment replay-comment">
                                    <figure class="thumb-box">
                                        <img style="height: 85px;" src="{{ url('upload/phamlong.jpg') }}" alt="">
                                    </figure>
                                    <div class="comment-inner">
                                        <div class="comment-info clearfix">
                                            <h5>{{ $rep->subject }}</h5>
