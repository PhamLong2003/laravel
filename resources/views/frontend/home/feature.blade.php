...
<section class="feature-section sec-pad bg-color-1">
    <div class="auto-container">
        <div class="sec-title centred">
            <h5>Đặc trưng</h5>
            <h2>Tài sản đặc trưng</h2>
            <p>Nhưng tài sản được quan tâm đến nhiều trong gần đây ngại gì mà không xem <br />để biết thêm thông tin.</p>
        </div>
        ...
        {{-- <div class="more-btn centred"><a href="property-list.html" class="theme-btn btn-one">Xem danh sách</a></div> --}}
    </div>
</section>