    ...
    <div class="auto-container">
        <div class="inner-container">
            <div class="content-box centred">
                <h2 style="font-size: 41px;font-family: sans-serif;">TẠO RA THƯƠNG HIỆU BẤT ĐỘNG SẢN RIÊNG CỦA BẠN</h2>
                <p>Chọn khác biệt, chọn thành công</p>
            </div>
            <div class="search-field">
                <div class="tabs-box">
                    <div class="tab-btn-box">
                        <ul class="tab-btns tab-buttons centred clearfix">
                            <li class="tab-btn active-btn" data-tab="#tab-1">Rao bán</li>
                            <li class="tab-btn" data-tab="#tab-2">Cho thuê</li>
                        </ul>
                    </div>
                                            ...
                                            <div class="col-lg-4 col-md-12 col-sm-12 column">
                                                <div class="form-group">
                                                    ...
                                                    <div class="field-input">
                                                        ...
                                                        <input type="search" name="search" placeholder="Tìm kiếm tên, ID, ..." required="">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="select-box">
                                                        ...
                                                        <select name="state" class="wide">
                                                           <option data-display="">Tất cả thành phố</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="select-box">
                                                        <select name="ptype_id" class="wide">
                                                           <option data-display="">Tất cả các loại</option>
