      ...
      <div class="d-none d-md-block col-md-4 col-xl-4 left-wrapper">
        <div class="card rounded">
          <div class="card-body">
            ...
            <div class="mt-3">
              <label class="tx-11 fw-bolder mb-0 text-uppercase">Tên đại lý:</label>
      ...
      <div class="col-md-8 col-xl-8 middle-wrapper">
        <div class="row">
            <div class="card">
                ...
                <h6 class="card-title">Cập nhật tài khoản đại lý</h6>
                ...
                <form method="POST" action="{{ route('agent.profile.store')}}"  class="forms-sample"  enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputUsername1"  class="form-label">Tên đại lý</label>
