            ...
            <form action="{{ route('store.business.plan') }}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-3 pe-0">
                        ...
                        <h4 class="text-end fw-normal">50.000VNĐ</h4>
                    ...
                    <div class="table-responsive w-100">
                        <table class="table table-bordered">
                            ...
                            <tr class="text-end">
                                ...
                                <td class="text-start">Gói thường</td>
                                <td>3</td>
                                <td>50.000 VNĐ</td>
                                <td>50.000 VNĐ</td>
                            </tr>
                        ...
                        <div class="col-md-6 ms-auto">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                    <td>Giá ban đầu</td>
                                    <td class="text-end">50.000 VNĐ</td>
                                    </tr>
                            
                                  
                                    <tr>
                                    <td>Thanh toán</td>
                                    <td class="text-danger text-end">- 50.000 VNĐ</td>
                                    </tr>
                                    <tr class="bg-dark">
                                    <td class="text-bold-800">Tổng phải trả</td>
                                    <td class="text-bold-800 text-end">50.000 VNĐ</td>
                                    </tr>
                                </tbody>
                            </table>
                            </div>
