      ...
      <div class="col-md-8 col-xl-8 middle-wrapper">
        <div class="row">
            <div class="card">
                ...
                <h6 class="card-title">Sửa lời chứng thực</h6>
                ...
                <form method="POST" action="{{ route('update.testimonials')}}"  class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="message" class="form-control" id="exampleFormControlTextarea1" rows="3" >{{$testimonials->message }}</textarea>
                       
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Ảnh lời chứng thực</label>
                        <input class="form-control" name="image"  type="file" id="image">                    
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label"></label>
                        <img id="showImage" class="wd-80 rounded-circle" src="{{ asset('storage/testimonial/'.$testimonials->image) }}" alt="profile">
