      ...
      <div class="col-md-8 col-xl-8 middle-wrapper">
        <div class="row">
            <div class="card">
                ...
                <h6 class="card-title">Cập nhật trang web</h6>
                ...
                <form id="myForm" method="POST" action="{{ route('update.site.setting')}}"  class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <label for="exampleInputEmail1" class="form-label">Bản quyền</label>
                    ...
                    <div class="mb-3">
                        ...
                        <img id="showImage" class="wd-80 rounded-circle" src="{{ asset('storage/site/' .$sitesetting->logo) }}" alt="profile">
