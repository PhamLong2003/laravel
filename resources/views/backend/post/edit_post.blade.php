      ...
      <div class="col-md-12 col-xl-12 middle-wrapper">
        <div class="row">
            <div class="card">
                ...
                <h6 class="card-title">Sửa bài viết</h6>
                ...
                <form method="POST" action="{{ route('update.post')}}"  class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="post_title" class="form-control" placeholder="Nhập tên bài viết" value="{{ $post->post_title }}">
                            </div>
                        </div><!-- Col -->
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            <label class="form-label">Gắn thẻ bài viết</label>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Ảnh bài viết</label>
                        <input class="form-control" name="post_image" type="file" id="image" >                    
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label"></label>
                        <img id="showImage" class="wd-80 rounded-circle"  src="{{ asset('storage/post/'.$post->post_image) }}" alt="profile">
                  
                    </div>
                   

                  
                    <button type="submit" class="btn btn-primary me-2">Cập nhật bài viết</button>
                </form>
